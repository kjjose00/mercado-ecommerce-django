...
class Products(models.Model):
    ...
    product_type=models.CharField(max_length=100,choices=PRODUCT_TYPES,default=ORGANIC_FRUITS)
    product_qty=models.PositiveIntegerField(default=0)
    product_image=models.ImageField(upload_to ='uploads/',blank=True)
    product_price=models.FloatField(validators=[MinValueValidator(0.0)],)
    product_discount=models.FloatField(validators=[MinValueValidator(0.0)],blank=True,default=0)
